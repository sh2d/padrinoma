...
The careful reader will find some wrong non-standard hyphenations, such
as \emph{Rebek-ka} (non-standard hyphenation is discouraged within
names).  These are due to still imperfect non-standard hyphenation
patterns, which are subject to further improvements.  If you find
examples of wrong German non-standard hyphenation, please send them to
