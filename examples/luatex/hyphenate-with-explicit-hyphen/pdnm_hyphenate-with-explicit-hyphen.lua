...
-- Create custom pattern matching function.  (Pattern matching results
-- are discarded later.)
local scan_node_list = padrinoma.create_node_list_scanner('ngerman', '../../patterns/hyph-de-1996-compound.pat.txt', 99, 99, -1, true)
